...
import refStyle from "./ReferancesSection.module.css";
import ColorContext from "../contexts/ColorContext";
function ReferancesSection() {
  const {
    secondaryColor,
    textColor,
    accentColor,
  ...
  return (
    <>
      <div
        className={`container ${refStyle["referances-container"]}`}
        style={{ color: `${textColor}` }}
      >
        <div className={refStyle["ref-header"]}>
          <h2>Testimonials</h2>
          <h5>What (imaginary) people are saying about this site.</h5>
        </div>
        <div className={refStyle["card-section"]}>
          <div
            className={refStyle["card"]}
            style={{
          ...
          >
            <div className={refStyle["review-box"]}>
              <div
                className={refStyle["review-img"]}
                style={{
                  background: `${primaryColor}`,
                  border: `2px solid ${textColor}`,
                }}
              ></div>
              <div className={refStyle["review-name"]}>
                <p>Yusuf Kağan Kılıç</p>
          ...
          >
            ...
            <p className={refStyle["comment"]}>
              "Amazing. I found my favorite colors in literally... 2 minutes?
              Woah! Totally real review."
            </p>
          </div>
          <div
            className={refStyle["card"]}
